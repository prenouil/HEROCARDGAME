...
description: Memory philosophy and practices for Documentaliste
---
...
- **BOND.md** — things about your owner (preferences, style, what works and doesn't) and about the game project you serve
- **PERSONA.md** — things about yourself (evolution log, traits you've developed)
- **`glossary.md` / `open-questions.md`** — your canon-keeping organic files (see `tenir-canon.md`)
- **`sources.md`** — external documents you watch (see `veille-sources.md`)
...
- **During Pulse** — curate session logs into MEMORY.md, update BOND.md with new preferences, run VE and note drift, review open-questions.md for stagnant entries
