...
| Flamèche | Mage | Départ | 1 én. + 0 mana | Ennemi | épée | Inflige 2 dégâts. Gagne 1 mana. | Inflige 3 dégâts. Gagne 1 mana. |
...
**Mage — "Flamèche"/"Barrière" remplacent "Coup direct"/"Encaisser" (2026-08-24) :** seule classe dont les deux cartes de base portent un nom différent des trois autres — même type de dégâts/catégorie que le "Coup direct" générique (physique/mêlée, confirmé volontaire malgré le thème "feu" du nom), leur seule vraie différence étant le gain de 1 mana à chaque utilisation. `mana_cost = 0` est affiché quand même sur ces deux cartes (pastille de mana visible sur les 6 cartes du Mage, pas seulement les 4 qui en dépensent réellement) — cohérence visuelle, pas une exigence mécanique.
...
- **Liste de cartes rééquilibrée le 2026-08-24 (24 cartes, voir Card Types and Effects)** — remplace la liste à 18 cartes du 2026-08-06 : cartes génériques retirées, chaque classe reçoit 6 cartes propres (3 Départ + 3 Avancé), Mage renommé Flamèche/Barrière, Guerrier ayant échangé les paliers Coup de taille/Coup d'estoc.
