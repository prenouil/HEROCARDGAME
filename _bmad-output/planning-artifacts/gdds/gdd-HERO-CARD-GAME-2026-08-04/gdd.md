...
| 2 | Identité de classe (4 héros MVP, Pouvoir de Classe, Transcendance, cartes de classe libres) | 4 | Prototypé — `proto-cartes-completes` est aligné sur le canon (Paladin, Assassin, cartes libres + Transcendance déclenchée par mot-clé, pas par classe d'origine) ; les 3 prototypes plus anciens restent en divergence (historique, non mis à jour) |
