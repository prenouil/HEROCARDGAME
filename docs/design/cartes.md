...
Reconstruit depuis le code le 2026-08-30 (`game/src/data/cards.lua`, 36 cartes — 6 classes × 6). Format repris de celui déjà utilisé par agent_content pour proposer des cartes : Nom | Classe | Palier | Coût | Mots-clés | Texte (base) | Texte amélioré.
...
- **Coût** : énergie (ressource d'équipe partagée, 3/tour) ; si la carte consomme en plus une ressource propre à sa classe, elle est notée à la suite (ex. "1 + 1 mana", "1 (+0-3 Corruption)" pour un coût variable plafonné).
...
|---|---|---|---|---|---|
| Coup direct | Départ | 0 | melee, degats | Inflige 4 "epee". | Inflige 6 "epee". |
...
| Coup de taille | Départ | 1 | melee, degats | Inflige 2 "epee" à tous les ennemis. | Inflige 3 "epee" à tous les ennemis. |
| Coup d'estoc | Avancé | 1 | melee, degats | Inflige 4 "epee". Inflige 4 "epee" de plus si l'ennemi a du "bouclier" ou "Vulnerabilite". | Inflige 6 "epee". Inflige 6 "epee" de plus si l'ennemi a du "bouclier" ou "Vulnerabilite". |
| Avalanche de coups | Avancé | 1 | melee, degats | Inflige 4 "epee" et son coût devient 0. Si cette attaque tue sa cible, Avalanche de coups revient dans la main du joueur. | Inflige 6 "epee" et son coût devient 0. Si cette attaque tue sa cible, Avalanche de coups revient dans la main du joueur. |
| Riposte | Avancé | 3 | melee, degats, defense | Si "cibleennemi", annule l'attaque et inflige la moitié des dégâts en retour. | Si "cibleennemi", annule l'attaque et inflige la totalité des dégâts en retour. |

Coup direct passe à coût 0 depuis le rééquilibrage du 2026-08-24. "Coup appuyé"/"Avalanche de coups" ont remplacé "Encaisser"/"Coup mortel" le 2026-08-28 — le Guerrier n'a donc plus de carte de bouclier propre en Départ, ce case du kit est devenu un 2ᵉ coup offensif. Riposte : le montant renvoyé est désormais proportionnel aux dégâts de l'attaque annulée (moitié/totalité) plutôt qu'un montant fixe ; ne se déclenche que contre une attaque de type dégâts (une Malédiction annulée ne renvoie rien). Avalanche de coups : dégâts 4 en base, 6 en amélioré — valeurs confirmées correctes telles quelles.
...
| Se cacher | Départ | 1 | defense, furtif | L'allié gagne 4 "bouclier". "Furtif" | L'allié gagne 6 "bouclier". "Furtif" |
| Repli stratégique | Départ | 1 | defense, furtif | L'allié gagne 4 "bouclier". Si "cibleennemi", l'ennemi change de cible pour cet allié. "Furtif" | L'allié gagne 6 "bouclier". Si "cibleennemi", l'ennemi change de cible pour cet allié. "Furtif" |
| En traître | Avancé | 2 | melee, degats, furtif | Si Camouflé, inflige 8 "epee", "Saignements" 3, "Discretion" 4. "Furtif" | Si Camouflé, inflige 12 "epee", "Saignements" 4, "Discretion" 6. "Furtif" |
| Assassinat | Avancé | 1 | melee, degats, furtif | Si Camouflé, inflige 12 "epee", sinon gagne "Discrétion" 2, "Puissance" 2 et Assassinat va sur le dessus du deck. "Furtif" | Si Camouflé, inflige 18 "epee", sinon gagne "Discrétion" 3, "Puissance" 3 et Assassinat va sur le dessus du deck. "Furtif" |
...
Refonte complète du 2026-08-28 : les 6 cartes remplacées d'un bloc (tableur fourni), les 3 de Départ ont aussi changé de nom (ex-"Coup direct"/"Encaisser" génériques). Toutes tagguées "Furtif" : les jouer ne fait pas perdre Discrétion/Camouflé, et une carte Furtif défaussée sans avoir été jouée rapporte +2 Discrétion. "En traître" est entièrement conditionnelle à Camouflé — sans Camouflé, elle ne fait strictement rien (le coût est payé pour rien). Se cacher : bouclier 4 en base, 6 en amélioré — valeurs confirmées correctes telles quelles. Assassinat a perdu "et perd Camouflé" (disparu du texte fourni) : la jouer ne fait plus perdre Discrétion/Camouflé du tout, qu'elle ait frappé en Camouflé ou non — changement de comportement notable vs. l'ancienne version.
...
| Voile d'ossements | Départ | 1 | defense | L'allié ciblé gagne 4 "bouclier". Le Nécromancien gagne 1 "bouclier" par Corruption. | L'allié ciblé gagne 6 "bouclier". Le Nécromancien gagne 2 "bouclier" par Corruption. |
| Pacte funeste | Avancé | 1 | sort, degats | Perd la moitié de ses "PV" actuels (arrondi au supérieur). Gagne autant de Corruption que de PV perdus. Inflige 2 "necrose" par PV perdu à un ennemi. | Perd le tiers de ses "PV" actuels (arrondi au supérieur) pour le même effet. |
...
Voile d'ossements lit la Corruption cumulée passivement (comme "Air belliqueux" côté Barde) sans jamais la dépenser — contrairement à Rite mineur/Servant d'os/Communion des morts. Servant d'os n'a aucun effet garanti à X=0 (confirmé volontaire, pas un oubli) : rien n'est programmé si le Nécromancien n'a pas de Corruption à ce moment.
...
| Nom | Palier | Coût | Mots-clés | Texte (base) | Texte amélioré |
|---|---|---|---|---|---|
| Air belliqueux | Départ | 1 | melee, degats | Inflige 5 "epee" à un ennemi. +2 par charge d'Inspiration sur les alliés. | Inflige 7 "epee" à un ennemi. +3 par charge d'Inspiration sur les alliés. |
...
| Dernier rappel | Avancé | 1 | sort | L'allié ciblé ne perd pas d'Inspiration à la fin de ce tour et gagne "Inspiration" 2. | L'allié ciblé ne perd pas d'Inspiration à la fin des 2 prochains tours et gagne "Inspiration" 3. |
| Bis | Avancé | 2 | sort | Si l'allié a de l'"Inspiration", celle-ci est retirée et la prochaine carte qu'il joue ce tour est jouée 2 fois. "Encore" | Si l'allié a de l'"Inspiration", celle-ci est retirée et la prochaine carte qu'il joue ce tour est jouée 3 fois. "Encore" |
| Rappel triomphal | Avancé | 3 | sort, defense | Tous les alliés gagnent "Inspiration" 2 et 6 "bouclier". | Tous les alliés gagnent "Inspiration" 3 et 9 "bouclier". |
...
- **Format de tableur totalement différent dans le GDD BMAD** (`gdd.md`, section cartes : colonnes Carte/Classe/Palier/Coût/Catégorie/Effet, sur les 4 classes MVP d'alors avec Transcendance) — obsolète, remplacé par le contenu ci-dessus. Ne pas s'y fier pour un seul nom de carte ou chiffre : quasiment toutes les cartes ont été rééquilibrées ou remplacées depuis (rééquilibrage complet du 2026-08-24, refontes Paladin/Assassin du 2026-08-28, ajout Nécromancien/Barde le 2026-08-29).
