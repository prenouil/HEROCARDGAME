...
- [Avancement de la reconstruction](project_avancement-reconstruction.md) — quels documents de `docs/design/` sont reconstruits, URL de l'Artifact combiné "tableur" (6 onglets), ce qui reste à faire (document de règles).
